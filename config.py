...
VAPID_EMAIL = "fahd200477@gmail.com"  # غيّره إلى بريدك الحقيقي

# إعدادات البريد الإلكتروني (Flask-Mail)
MAIL_SERVER = 'smtp.googlemail.com'
MAIL_PORT = 587
MAIL_USE_TLS = True
MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'fahd200477@gmail.com'
MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'ktlp wlwv uplm zmal'
